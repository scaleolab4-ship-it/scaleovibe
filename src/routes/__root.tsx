    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-brand-gradient px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-brand"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "scaleo_lab — Business, AI Automation & SaaS Studio" },
      {
        name: "description",
        content:
          "scaleo_lab by Yeasin — business strategy, AI automation, SaaS builds and agency systems.",
      },
      { name: "author", content: "Yeasin — scaleo_lab" },
